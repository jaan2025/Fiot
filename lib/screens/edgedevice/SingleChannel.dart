...
class SingleChannel extends ConsumerStatefulWidget {

  Map ? valueMap;

  SingleChannel({ this.valueMap, Key? key}) : super(key: key);

  @override
  _SingleChannel createState() => _SingleChannel();
}

class _SingleChannel extends ConsumerState<SingleChannel> {
